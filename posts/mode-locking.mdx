...
<Image alt={`GUI`} src={`/images/mode-locking/GUI.png`} width={1186} height={698}  />
...
<Image alt={`emission`} src={`/images/mode-locking/emission.png`} width={549} height={299}  />
...
<Image alt={`Inversion`} src={`/images/mode-locking/inversion.png`} width={1186} height={698}  />
...
<Image alt={`distribution`} src={`/images/mode-locking/distribution.jpg`} width={767} height={258}  />
...
<Image alt={`levels`} src={`/images/mode-locking/levels.png`} width={495} height={179}  />
...
<Image alt={`Standing Waves`} src={`/images/mode-locking/standing_waves.jpg`} width={423} height={358}  />
...
<Image alt={`NdYag_laser`} src={`/images/mode-locking/NdYag_laser.png`} width={765} height={249}  />
...
<Image alt={`fabry`} src={`/images/mode-locking/fabry.png`} width={400} height={193}  />
...
<Image alt={`confocal`} src={`/images/mode-locking/confocal.png`} width={401} height={398}  />
...
<Image alt={`longitudinal`} src={`/images/mode-locking/longitudinal.png`} width={403} height={316} />
...
<Image alt={`gain_medium`} src={`/images/mode-locking/gain_medium.gif`} width={476} height={540}  />
...
<Image alt={`mode_lock`} src={`/images/mode-locking/mode_lock.png`} width={521} height={515}  />
...
<Image alt={`transverse_longitudinal`} src={`/images/mode-locking/transverse_longitudinal.png`} width={596} height={428}  />
...
<Image alt={`gaussian`} src={`/images/mode-locking/gaussian.png`} width={790} height={335}  />


## Sources

* [Spontaneous and Stimulated Processes](https://micro.magnet.fsu.edu/primer/java/lasers/electroncycle/index.html)
* [Stimulated emission - Wikipedia](https://en.wikipedia.org/wiki/Stimulated_emission)
* [Theodore Maiman - Wikipedia](https://en.wikipedia.org/wiki/Theodore_Maiman)
* [Introduction of Gaussian Beam](https://flex.phys.tohoku.ac.jp/~rsaito/saito20-GaussianBeam.pdf)
* [Transverse Laser Modes](https://laser.physics.sunysb.edu/_alex/tmodes/webreport.html)
* [Laser Basics](https://www.slideshare.net/dlorenser/part-i-laser-basics-lorenser-2009)
* [Stimulated Emission](https://www.rp-photonics.com/stimulated_emission.html)
* [Lasers - Basic Concepts](https://spie.org/samples/TT53.pdf)
* [Laser Resonator Modes - Edmund Optics](https://www.edmundoptics.com.sg/knowledge-center/application-notes/lasers/laser-resonator-modes/)
* [Critical Laser Components - mks Newport](https://www.newport.com/n/critical-laser-components)
* [Lasers](http://labman.phys.utk.edu/phys222core/modules/m11/lasers.html)
* [Decay of metastable state: spontaneous vs. stimulated emission.](https://physics.stackexchange.com/questions/75247/decay-of-metastable-state-spontaneous-vs-stimulated-emission)
* [SS Laser Testing, Adjustment, Repair](https://www.photonlexicon.com/laserfaq/laserstr.htm)
